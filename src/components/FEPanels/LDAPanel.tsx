            ...
            {howOpen && (
              <div style={{
                ...
                <ol style={{ margin: 0, paddingLeft: "1.1rem", display: "flex", flexDirection: "column", gap: "0.35rem" }}>
                  <li><strong style={{ color: ACCENT }}>Build stopword set</strong> — built-in ~320 common English words (industry-standard coverage: the, a, is, are, also, because, during, either…) are always removed. If you enter custom stopwords, they are merged on top. Default stopwords apply regardless.</li>
