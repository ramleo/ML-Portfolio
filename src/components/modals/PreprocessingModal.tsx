          ...
          <div style={{ borderRadius: 8, border: "1px solid rgba(129,140,248,0.22)", overflow: "hidden" }}>
            ...
            {guideOpen && (
              <div style={{ padding: "1rem", fontSize: "0.75rem", color: "var(--text2)", lineHeight: 1.75,
                ...
                <p style={{ margin: 0 }}>
                  Each card shows one numeric column <strong style={{ color: "var(--text)" }}>before</strong> and <strong style={{ color: "var(--text)" }}>after</strong> preprocessing.
                  The <strong style={{ color: "var(--text)" }}>bell curve</strong> represents how values are distributed — its shape tells you
                  whether data clusters tightly around the mean or has a long tail of outliers.
                </p>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.35rem" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "0.6rem" }}>
                      ...
                      <span><strong style={{ color: "var(--text)" }}>After (vivid)</strong> — cleaned distribution. A high-skew column like <em>Fare</em> that had log transform applied will look noticeably more symmetric.</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "0.25rem", color: "var(--text3)" }}>
                    <div>
                      ...
                      Column was dropped — either manually selected or removed by preprocessing.
                    </div>
                    <div>
                      <span style={{ color: ACCENT, marginRight: 6 }}>+N new columns (encoding)</span>
                      New columns added by one-hot encoding of categorical columns.
                    </div>
                  </div>
                </div>
