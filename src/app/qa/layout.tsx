...
export const metadata: Metadata = {
  ...
  description:
    "Testwright is the QA-automation platform inside AIRaML: describe a browser test in plain English and get a runnable Playwright TypeScript test with resilient locators. Free, and it runs and self-heals your tests on isolated CI.",
};
