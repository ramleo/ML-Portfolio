...
// The body of the Text-to-SQL user guide — the 14 sections and their
// presentational helpers. Split out of UserGuideModal.tsx so the modal shell
// (overlay, search, scroll container, footer) stays small. Rendered inside the
// modal's scroll area; search filters these <section> blocks by text content.

export const ACCENT = "#6a6cc8";

function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section className="mb-8" data-guide-section data-title={title}>
...
export default function GuideContent() {
  return (
    <>
      {/* Intro */}
      <div className="mb-6 p-4 rounded-xl border border-indigo-500/20" data-guide-section data-title="Overview"
