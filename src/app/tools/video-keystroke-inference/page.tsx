...
export default function VideoKeystrokeInferencePage() {
  ...
  const handleBack = useCallback(() => router.push(toolBackHref("video-keystroke-inference")), [router]);
    ...
    <div className="relative min-h-screen overflow-x-hidden" style={{ color: "var(--text)" }}>
      ...
      <div role="main" className="relative z-10 flex flex-col gap-6 pt-6 pb-12">
        <div className="max-w-6xl mx-auto px-4 w-full">
          <ToolBackNav toolId={"video-keystroke-inference"} />
          ...
          <KeystrokeUserGuideModal open={guideOpen} onClose={() => setGuideOpen(false)} />
