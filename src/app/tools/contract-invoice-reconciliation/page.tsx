  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden" style={{ color: "var(--text)" }}>
      ...
      <ToolsAIChat context={{
        ...
        suggestions: RECONCILIATION_SUGGESTIONS,
      }} />

      <div role="main" className="relative z-10 flex flex-col gap-6 pt-6 pb-12">
        <div className="max-w-7xl mx-auto px-4 w-full">
          <ToolBackNav toolId={"contract-invoice-reconciliation"} />
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-bold">Contract/Invoice Reconciliation</h1>
              ...
              <p className="text-xs mt-0.5" style={{ color: "var(--text3)" }}>
                Upload a contract and its invoices — flags amounts, dates, and terms that don&apos;t match
              </p>
            </div>
