...
export function TrialHistoryChart({ trials, bestTrial, primaryMetricLabel, secondaryTrials, secondaryMetricLabel }: TrialHistoryProps) {
  ...
  return (
    <div style={{ background: "var(--bg-glass)", backdropFilter: "blur(14px)", border: "1px solid var(--border)", borderRadius: 10, padding: "0.9rem 1rem" }}>
...
export function LearningCurveChart({ trainSizes, trainScores, valScores, metricLabel }: LearningCurveProps) {
  ...
  return (
    <div style={{ background: "var(--bg-glass)", backdropFilter: "blur(14px)", border: "1px solid var(--border)", borderRadius: 10, padding: "0.7rem 1rem" }}>
