          ...
          {result && (
            <>
              ...
              <div style={{ padding: "0.85rem 1rem", background: `${ACCENT}10`, border: `1px solid ${ACCENT}25`, borderRadius: 10 }}>
                <div style={{ fontSize: "0.7rem", fontWeight: 700, color: ACCENT, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: "0.3rem" }}>Best CV Score — {result.winner}</div>
                <div style={{ fontSize: "1.8rem", fontWeight: 800, color: ACCENT }}>{result.cv_results[0]?.score?.toFixed(4) ?? "—"}</div>
              </div>
              ...
              {result.feature_importance.length > 0 && (
                <div>
                  <div style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--text3)", textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: "0.6rem" }}>Feature Importance</div>
