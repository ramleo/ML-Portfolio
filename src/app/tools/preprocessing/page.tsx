          ...
          <div style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", gap: "1.5rem", alignItems: "stretch", flex: 1, overflow: "hidden", minHeight: 0 }}>
              ...
              <div style={{ flex: 1, minWidth: 0, overflowY: "auto", display: "flex", flexDirection: "column", gap: "1.25rem", paddingRight: 4, paddingBottom: "2rem" }}>
                ...
                {/* Toggles */}
                <RepulsionCard style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.65rem", padding: "1rem", borderRadius: 12, background: CARD_BG, border: "1px solid var(--border)" }}>
          ...
          <div style={{ maxWidth: 960, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "0.75rem", marginBottom: "1.25rem" }}>
              {[
                ...
                return (
                  <RepulsionCard key={s.label} style={{ padding: "0.85rem 1rem", borderRadius: 12, background: CARD_BG, border: "1px solid var(--border)" }}>
